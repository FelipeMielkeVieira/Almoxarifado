...
@Component({
  selector: 'app-editar-descricao-item',
  templateUrl: './editar-descricao-item.component.html',
  styleUrls: ['./editar-descricao-item.component.scss']
})
export class EditarDescricaoItemComponent implements OnInit {
