...
@Component({
  selector: 'app-reserva-professor',
  templateUrl: './reserva-professor.component.html',
  styleUrls: ['./reserva-professor.component.scss']
})
export class ReservaProfessorComponent implements OnInit {

  @Input() reserva = {id: 0, data_retirada: '0000-00-00', data_devolucao: '0000-00-00', status: 0, usuario_email: ''};
